...
Partial Class FrmArray
    ...
    Private Sub InitializeComponent()
        ...
        ' btnTampilkan
        ' 
        btnTampilkan.Location = New Point(357, 264)
        ...
        ' txtPanjang
        ' 
        txtPanjang.Location = New Point(345, 152)
        ...
        lblPanjang.Location = New Point(252, 155)
        ...
        lblLebar.Location = New Point(252, 212)
        ...
        ' txtLebar
        ' 
        txtLebar.Location = New Point(345, 206)
